...
#유튜버 이름들
youtubers = {'dreamteller','gmovie','gomong','kimsiseon','moviethink'}

description_list = []

for youtuber in youtubers:
    data = pd.read_excel(f'{youtuber}/{youtuber}_review_{current_week}주차.xlsx')
...
# CSV 파일로 저장
df_description.to_csv('description_list.csv', index=False)
